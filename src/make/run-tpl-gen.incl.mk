...
do-tpl-gen: demand_var-ORG demand_var-ENV demand_var-APP
	docker exec -e TPL_SRC=$(TPL_SRC) -e CNF_SRC=$(CNF_SRC) -e ORG=$(ORG) -e APP=$(APP) -e ENV=$(ENV) -e TGT=$(TGT) -e SRC=$(SRC) $(ORG)-tpl-gen-tpl-gen-con make ${PRODUCT}
...
run-tpl-gen: demand_var-ORG demand_var-ENV demand_var-APP
	$(call run-img,tpl-gen,,${TPL_GEN_PORT}, make $(product))
...
do-yaml-to-json-file:
	docker exec -e TGT=$(TGT) -e SRC=$(SRC) $(ORG)-tpl-gen-tpl-gen-con make yaml-to-json-file
