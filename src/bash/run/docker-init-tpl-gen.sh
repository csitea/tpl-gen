...
venv_path="/${PP_NAME}/${ORG_DIR}/${PRODUCT}/src/python/tpl-gen/.venv"
...
echo "source /${PP_NAME}/${ORG_DIR}/${PRODUCT}/src/python/${PRODUCT}/.venv/bin/activate" >> /home/$APPUSR/.bashrc
# /home/appusr/.local/share/pypoetry/venv/bin/activate 
# -> /home/appusr/.local/share/pypoetry/venv/bin/activate

cd /${PP_NAME}/${ORG_DIR}/${PRODUCT}/
